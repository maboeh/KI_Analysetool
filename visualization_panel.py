...
class DataVisualizationPanel:
    ...
    def _create_chart_display(self):
        ...
        # Export buttons
        export_help_frame = ttk.Frame(control_frame)
        export_help_frame.pack(side=tk.LEFT)
        ttk.Button(
            export_help_frame,
        ...
        chart_type_label_frame = ttk.Frame(control_frame)
        chart_type_label_frame.pack(side=tk.LEFT, padx=2)
        ttk.Label(chart_type_label_frame, text="Diagrammtyp:").pack(side=tk.LEFT)
        add_help_indicator(chart_type_label_frame,
                          "Wählen Sie den Diagrammtyp: Balken (BAR), Linie (LINE), "
                          "Kreis (PIE), Streuung (SCATTER) oder Histogramm.")
