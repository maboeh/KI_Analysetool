...
class ResultsDisplayWidget(ttk.Frame):
    ...
    def _setup_widget(self):
        ...
        # Help for zoom controls
        add_help_indicator(zoom_frame,
                          "Vergrößert oder verkleinert die Schrift im Ergebnisbereich. "
                          "Reset stellt die Standardgröße wieder her.")
        ...
        # Help for view options
        add_help_indicator(view_frame,
                          "Klappt alle markierten Abschnitte im Ergebnis-Text ein oder aus, "
                          "um längere Ausgaben übersichtlicher zu gestalten.")
